#ifndef __TOUCHLIB_FILTER_XORBG__
...
class MOTION_DETECTOR_CORE_API XorBGFilter : public Filter
{
	DECLARE_DYNAMIC_CLASS_NO_COPY(XorBGFilter)
public:
	XorBGFilter();
	virtual ~XorBGFilter();
...
#endif // __TOUCHLIB_FILTER_XORBG__
